...
#println("$gamertag2 played $items2 games on $pages2 pages.")
#println("**********************************************************")
...
println("This will take an estimated $totalSecs sec / $totalMins min / $totalHrs hrs.")
